    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_image', models.ImageField(default='user_images/user_images.jpg', upload_to='user_images/', validators=[users.models.validate_image_size])),
                ('user_bio', models.TextField(blank=True, default='', max_length=500, validators=[users.models.validate_bio_length])),
                ...
                ('following', models.ManyToManyField(blank=True, related_name='chat_following', to=settings.AUTH_USER_MODEL)),
